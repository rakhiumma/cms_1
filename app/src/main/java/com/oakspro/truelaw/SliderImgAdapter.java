...
public class SliderImgAdapter extends SliderViewAdapter<SliderImgAdapter.SliderAdapterVH> {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        Picasso.get().load(sliderItem.getAd_img()).into(viewHolder.imageViewBackground);
